...
void ShowHelp::onPluginLoad()
{
  glwidget()->makeCurrent();
    ...
    vs->compileSourceFile("/Users/epord/UPC/G/NewViewer_1b32186/plugins/show-help/show.vert");

    fs = new QOpenGLShader(QOpenGLShader::Fragment, this);
    fs->compileSourceFile("/Users/epord/UPC/G/NewViewer_1b32186/plugins/show-help/show.frag");
