...
void Glowing::onPluginLoad()
{
    ...
    vs->compileSourceFile("/Users/epord/UPC/G/NewViewer_1b32186/plugins/glowing/glowing.vert");
    cout << "VS log:" << vs->log().toStdString() << endl;

    fs = new QOpenGLShader(QOpenGLShader::Fragment, this);
    fs->compileSourceFile("/Users/epord/UPC/G/NewViewer_1b32186/plugins/glowing/glowing.frag");
